...
const BreakSection = () => {
	return (
		<div className="bg-orange py-10 font-Baloo text-white flex justify-center items-center flex-col -mx-4 md:-mx-16 lg:-mx-[6rem] xl:-mx-[calc((100vw-1024px)/2)] xxl:-mx-[calc((100vw-1240px)/2)]  xxxl:-mx-[calc((100vw-1456px)/2)] relative overflow-hidden">
			<h2 className="pb-2 text-3xl font-bold">Do You Have Any Projects?</h2>
			<p className="pb-6 text-lg">Contact Us For a Free Quote</p>
