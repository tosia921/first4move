...
const ImageBullets = () => {
	return (
		<div className="page-padding flex flex-col-reverse md:flex-row mb-12 relative md:my-[75px]">
			...
			<div className="grid w-full py-6 md:w-1/2 relative">
				<div
					className="relative bg-blue	 justify-self-end self-end w-[90%] h-[90%] rounded-bl-3xl"
					style={{
						gridArea: '1/1',
					}}
				></div>
				<div className="absolute top-[20%] -right-[27px] hidden lg:block">
					<Subtract className="fill-blue" />
				</div>
				<StaticImage
