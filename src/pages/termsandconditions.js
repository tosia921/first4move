			...
			<section className="page-padding my-10">
				<div>
					...
					<p className="mb-2">
						...
						together with our privacy policy govern 123RenovatorEdinburgh’s relationship with you in relation to this website.
					</p>
					<p className="mb-2">
						If you disagree with any part of these terms and conditions, please do not use our website. The term ‘123RenovatorEdinburgh’ or ‘us’ or ‘we’ refers to the owner of the website whose
						registered office is at Edinburgh, EH1 24W.
					</p>
